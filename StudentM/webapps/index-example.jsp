...
<link rel="stylesheet"
	href="<c:url value="resources/test/ui.css" />"></link>
	<link rel="stylesheet"
	href="<c:url value="resources/test/jquery-ui.css" />"></link>

	<script type="text/javascript"
	src="<c:url value="resources/test/jquery_002.js" />"></script>
	<script type="text/javascript"
	src="<c:url value="resources/test/jquery-ui.js" />"></script>
<script type="text/javascript"
	src="<c:url value="resources/test/grid.js" />"></script>
<script type="text/javascript"
	src="<c:url value="resources/test/jquery.js" />"></script>
